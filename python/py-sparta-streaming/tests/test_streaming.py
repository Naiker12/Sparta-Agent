...
from sparta_streaming.event_bridge import _emit, stream_agent_to_electron
...
class TestEventBridge:
    ...
    async def test_stream_basic_events(self):
        ...
        with patch("sparta_streaming.event_bridge._emit") as mock_emit:
    ...
    async def test_stream_error_handling(self):
        ...
        with patch("sparta_streaming.event_bridge._emit") as mock_emit:
            await stream_agent_to_electron(mock_graph, {}, "req_001")
            error_calls = [c for c in mock_emit.call_args_list if c[0][1] == "stream:error"]
