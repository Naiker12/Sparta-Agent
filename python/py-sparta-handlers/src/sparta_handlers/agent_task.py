...
from sparta_handlers.workspace import _session_workspaces
...
async def run_agent_task(
    *,
    ...
    from sparta_tools.permission_broker import set_agent_autonomy
    set_agent_autonomy(agent_autonomy)

    if workspace_root:
        _session_workspaces[task_id] = workspace_root
        from sparta_tools.file_tools import set_session_workspace
    ...
    try:
        ...
        from sparta_tools.terminal_tools import terminal_execute_tool, terminal_check_tool
        from sparta_tools.memory_tools import read_memory_tool
