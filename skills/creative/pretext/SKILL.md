...
This skill exists so Hermes can make **cool demos** with it â€” the kind people post to X. See `pretext.cool` and `chenglou.me/pretext` for the community demo corpus.
