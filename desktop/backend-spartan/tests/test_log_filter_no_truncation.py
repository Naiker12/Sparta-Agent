...
class TestNoTruncation:
    def test_gguf_size_summary_survives(self):
        # Mirrors the f-string at studio/spartan_backend/core/inference/llama_cpp.py:2117
        event = (
    ...
    def test_mmproj_path_survives(self):
        # Mirrors logger.info at studio/spartan_backend/core/inference/llama_cpp.py:2283
        event = (
    ...
    def test_llama_server_command_survives(self):
        # Mirrors logger.info at studio/spartan_backend/core/inference/llama_cpp.py:2312
        event = (
    ...
    def test_traceback_with_paths_survives(self):
        traceback_str = (
            ...
            'studio/spartan_backend/core/inference/llama_cpp.py", line 2312, in start\n'
