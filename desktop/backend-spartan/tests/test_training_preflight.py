...
from studio.spartan_backend.core.training import training as training_mod
from utils.hardware import hardware as hw
...
def fake_activate(model_name, hf_token):
    events.append({
        ...
        "trainer_loaded": "studio.spartan_backend.core.training.trainer" in sys.modules,
    })
...
"""
    ...
    assert payload["trainer_module"] == "studio.spartan_backend.core.training.training"
