...
copy of the route's cursor loop (studio/spartan_backend/routes/inference.py), asserting
...
def _replay_route_cursor(events: list[dict]) -> dict:
    ...
    Mirrors studio/spartan_backend/routes/inference.py: reset ``prev_text`` on empty
