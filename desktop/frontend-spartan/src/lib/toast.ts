...
const SPANISH_TOASTS: Record<string, string> = {
  ...
  "A model is loading": "Se está preparando una conexión de proveedor",
  "Another model is already loading": "Ya hay una conexión de proveedor en preparación",
  "Stopped loading model": "Se canceló la preparación de la conexión",
