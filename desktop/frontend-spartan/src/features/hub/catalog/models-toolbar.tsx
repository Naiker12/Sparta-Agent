      ...
      <div className="flex min-w-0 flex-wrap items-center gap-2 lg:flex-[0_0_auto] lg:flex-nowrap lg:justify-end">
        ...
        {tab === "discover" && !isDataset && (
          <HubOptionMenu
            ...
            ariaLabel={t("hub.capabilityFilter")}
            className={cn(triggerBase, "w-[128px]")}
          />
        )}
