...
const REMOTE_CMD_UNIX = `export SPARTAN_STUDIO_URL=https://studio.example.com
export SPARTAN_API_KEY=sk-spartan-...
spartan start claude`;

// PowerShell uses $env: assignments; export is POSIX-only.
const REMOTE_CMD_WINDOWS = `$env:SPARTAN_STUDIO_URL = "https://studio.example.com"
$env:SPARTAN_API_KEY = "sk-spartan-..."
spartan start claude`;
