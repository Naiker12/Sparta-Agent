...
export type FineTuneAction = "recipes" | "export";
...
const FINE_TUNE_VALUES: FineTuneAction[] = ["recipes", "export"];
  ...
  return {
    ...
    resourcesLiveUpdates:
      typeof raw.resourcesLiveUpdates === "boolean"
        ...
        : true,
    fineTuneAction: oneOf(raw.fineTuneAction, FINE_TUNE_VALUES, "recipes"),
  };
}
