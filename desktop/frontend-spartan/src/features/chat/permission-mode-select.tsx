...
export function usePermissionModeOptions() {
  ...
  return [
    {
      value: "ask" as PermissionMode,
      label: t("chat.composer.permissions.ask.label"),
      description: t("chat.composer.permissions.ask.description"),
      icon: Hand,
    },
    {
      value: "auto" as PermissionMode,
      label: t("chat.composer.permissions.auto.label"),
      description: t("chat.composer.permissions.auto.description"),
      icon: ShieldCheck,
    },
    {
      value: "off" as PermissionMode,
      label: t("chat.composer.permissions.off.label"),
      description: t("chat.composer.permissions.off.description"),
      icon: SparklesGlyph,
    },
    {
      value: "full" as PermissionMode,
      label: t("chat.composer.permissions.full.label"),
      description: t("chat.composer.permissions.full.description"),
      icon: CircleAlert,
    },
  ];
}
