...
// Mirrors split_quant_suffix in studio/spartan_backend/utils/openai_auto_switch_settings.py.
...
// Mirrors _GGUF_SPLIT_SUFFIX_RE in studio/spartan_backend/hub/utils/gguf.py.
...
/** Mirrors _gguf_stem in studio/spartan_backend/hub/utils/gguf.py, for a bare filename. */
