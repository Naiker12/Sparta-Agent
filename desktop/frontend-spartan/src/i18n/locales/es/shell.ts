export const shell = {
  ...
  dialog: {
    project: {
      ...
      deleteDescription:
        '¿Eliminar el proyecto "{name}"? Sus chats se eliminarán de forma permanente.',
      deleteWorkspaceDescription:
        "La carpeta del espacio de trabajo del proyecto se eliminará del disco.",
  ...
  startup: {
    ...
    packagesNeeded: "Se deben instalar los siguientes paquetes del sistema:",
    serverStopped: "El servidor se detuvo",
    ...
    copyFailed:
      "No se pudo copiar al portapapeles. Selecciona y copia los diagnósticos de abajo.",
