export const voice = {
  ...
  dictation: {
    ...
    speechBlocked:
      "El reconocimiento de voz fue bloqueado por el navegador. Revisa los permisos del micrófono.",
    speechServiceBlocked:
      "El servicio de voz del navegador bloqueó el reconocimiento de voz.",
    speechNetwork:
      "El reconocimiento de voz no pudo conectar con el servicio de voz del navegador.",
    speechLangUnsupported:
      "El reconocimiento de voz no es compatible con el idioma actual.",
