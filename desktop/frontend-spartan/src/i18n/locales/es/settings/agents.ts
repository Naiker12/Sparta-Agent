export const agents = {
  title: "Agentes",
  description:
    "Conecta agentes de programación como Claude Code y Codex a un modelo local con Spartan start.",
  intro:
    "conecta Claude Code, Codex, Hermes, OpenClaw, OpenCode y otros agentes a un modelo servido localmente por Spartan, totalmente sin conexión. Ejecuta un servidor compatible con OpenAI y nunca modifica los archivos de configuración de tu agente.",
  ...
  modelNote:
    "Codex requiere un modelo GGUF servido por llama-server. Otros agentes también pueden usar modelos basados en transformers; quita --model para usar el modelo ya cargado en Spartan.",
  subagent: {
    title: "Usar un modelo local como subagente",
    description:
      "Mantén {agent} en su modelo actual y delega tareas concretas en este modelo local de Spartan.",
  ...
  options: {
    ...
    description:
      "Primero se procesan las opciones de Spartan; todo lo que Spartan no reconoce se pasa directamente al agente.",
    model:
      "Selecciona un modelo. Sin --model, Spartan start usa el modelo cargado actualmente en Studio y da error si no hay ninguno.",
    contextLength:
    ...
    persist:
      "Conserva entre ejecuciones el almacenamiento de agentes que gestiona Spartan.",
    asSubagent:
      "Mantén el agente principal en su modelo actual y registra Spartan como subagente local (Claude Code, Codex y OpenCode).",
  ...
  remote: {
    ...
    description:
      "Apunta Spartan start a un Studio que se ejecuta en otro lugar definiendo estas variables antes de iniciar el agente (o pasa --api-key directamente):",
  },
  passthrough: {
    title: "Pasar argumentos al agente",
    description:
      "Los argumentos que van después de las opciones de Spartan se reenvían al propio agente, así que comandos nativos como resume siguen funcionando:",
  },
  dryRun: {
