export const general = {
  ...
  passwordDialog: {
    ...
    setDescription:
      "Elige la contraseña con la que los navegadores remotos inician sesión como Spartan (al menos {minLength} caracteres). La app de escritorio de Spartan sigue iniciando sesión automáticamente.",
  ...
  helperLlm: {
    ...
    disabledByEnv:
      "Desactivado por SPARTAN_HELPER_MODEL_DISABLE en el entorno del backend.",
  ...
  modelAutoSwitch: {
    ...
    idleActiveViaEnv:
      "La descarga automática por inactividad está activa mediante la variable de entorno SPARTAN_MODEL_IDLE_TTL.",
    loadError:
  ...
  startup: {
    ...
    launchAtLoginDescription:
      "Inicia Spartan en segundo plano cuando inicias sesión. Permanece en la barra de menús o en la bandeja del sistema hasta que lo abras.",
    closeToTray: "Cerrar en la bandeja del sistema",
    closeToTrayDescription:
      "Mantén Spartan y su servidor ejecutándose en segundo plano al cerrar la ventana principal.",
  ...
  resetPreferences: {
    ...
    confirmDescription:
      "Borra las preferencias solo locales y recarga Spartan. Se conservan los chats, el acceso a la API y la configuración almacenada en la base de datos.",
  ...
  permissions: {
    ...
    bypassDescription:
      "Cómo aprueba Spartan las llamadas a herramientas del chat (terminal, python, web, MCP) antes de ejecutarlas. El modo «Full access» desactiva las aprobaciones y el sandbox de código.",
  },
} as const;
