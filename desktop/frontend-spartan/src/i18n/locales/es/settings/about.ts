export const about = {
  ...
  update: {
    ...
    desktopExternalServer:
      "Ejecuta `Spartan Studio update` desde el terminal que inició el servidor.",
    ...
    desktopCurrentDescription:
      "Spartan seguirá buscando actualizaciones automáticamente.",
    ...
    unknownInstall:
      "No se pudo detectar cómo se instaló Spartan. Para instalaciones con el instalador o desde PyPI, usa los comandos anteriores.",
    localCheckout:
