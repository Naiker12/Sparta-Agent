export const resources = {
  title: "Sistema",
  description:
    "Monitorea el hardware y el almacenamiento de este servidor de Spartan.",
  ...
  llamaBackend: {
    ...
    envLocked:
      "Fijado en {backend} por la variable de entorno SPARTAN_LLAMA_CPP_BACKEND, que tiene prioridad sobre este ajuste.",
    customPath: {
    ...
    unsupported: {
      ...
      localLink:
        "llama.cpp es un directorio local que enlazaste tú, así que Spartan no lo reemplazará.",
      sourceBuild:
  ...
  modelMemory: {
    ...
    noRamReserveHint:
      "Transfiere los pesos a la VRAM en lugar de mantener una copia completa en la RAM. Conserva la carga mapeada en memoria de llama.cpp y elimina --no-mmap y --mlock.",
    mlockVetoed:
