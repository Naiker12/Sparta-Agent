...
export const en = {
  ...
  images: {
    ...
    workflows: {
      create: { label: "Create", heading: "Create images", hint: "Generate a new image from a prompt" },
      transform: { label: "Transform", hint: "Redraw an image from your prompt" },
      inpaint: { label: "Inpaint", hint: "Regenerate a painted region" },
      extend: { label: "Extend", hint: "Grow the canvas and fill the edges" },
      upscale: { label: "Upscale", hint: "Enlarge and re-detail an image" },
      reference: { label: "Reference", hint: "Generate guided by a reference image" },
      edit: { label: "Edit", hint: "Change an image with an instruction" },
    },
  },
  runSettings: {
    title: "Run settings",
  ...
  settings: {
    ...
    voice: {
      ...
      dictation: {
        ...
        sttLoaded: "Loaded",
        sttUnavailable:
          "Not installed on this server. Run `Spartan Studio update` to enable local dictation.",
        sttRetry: "Retry",
        ...
        micAccessBlocked:
          "Microphone access was blocked. Allow microphone access for this Spartan page, then try again.",
    ...
    profile: {
      ...
      stats: {
        title: "Your stats",
        subtitle:
          "Everything below is counted from your own history. Nothing is collected or sent to Spartan.",
        retry: "Try again",
        privacyNote:
          "Stats are computed from the chat and training history held by your Spartan install. Nothing is collected, and nothing is sent to Spartan or any third party.",
        emptyChats:
    ...
    apiKeys: {
      ...
      secureHttpsHint:
        "The 0.0.0.0 port is still reachable globally. For full security, launch Spartan with --secure to expose only this HTTPS link.",
    ...
    about: {
      ...
      shutDownStudio: "Shut down Spartan",
      shutDownStudioDescription:
        "Stops the Spartan server and ends your session.",
      shutDown: "Shut down",
      update: {
        ...
        desktopExternalServer:
          "Run `Spartan Studio update` from the terminal that started your server.",
        ...
        desktopCurrentDescription:
          "Spartan will continue checking automatically.",
        ...
        unknownInstall:
          "Could not detect how Spartan was installed. For installer or PyPI installs, use the commands above.",
        localCheckout:
  ...
  studio: {
    ...
    trainingStart: {
      ...
      terminalStart: "> Spartan training starts...",
