...
export const es = {
  ...
  images: {
    ...
    workflows: {
      create: { label: "Crear", heading: "Crear imágenes", hint: "Genera una imagen nueva a partir de una descripción" },
      transform: { label: "Transformar", hint: "Redibuja una imagen siguiendo tu descripción" },
      inpaint: { label: "Retoque", hint: "Regenera una zona pintada" },
      extend: { label: "Extender", hint: "Amplía el lienzo y rellena los bordes" },
      upscale: { label: "Mejorar resolución", hint: "Amplía y recupera detalles de la imagen" },
      reference: { label: "Referencia", hint: "Genera una imagen guiada por una imagen de referencia" },
      edit: { label: "Editar", hint: "Modifica una imagen con una instrucción" },
    },
  },
  runSettings: {
  ...
  picker: {
    ...
    trending: "Tendencias",
    noConnectedModels:
      "No hay modelos de tus conexiones. Configúralos en Ajustes y luego Conexiones.",
    noMatchingCustomFolderModels:
      "No hay modelos coincidentes en las carpetas personalizadas.",
  ...
  settings: {
    ...
    voice: {
      ...
      dictation: {
        ...
        sttLoaded: "Cargado",
        sttUnavailable:
          "No está instalado en este servidor. Ejecuta `Spartan Studio update` para habilitar el dictado local.",
        sttRetry: "Reintentar",
        ...
        micAccessBlocked:
          "Se bloqueó el acceso al micrófono. Permite el acceso al micrófono para esta página de Spartan e inténtalo de nuevo.",
    ...
    general: {
      ...
      password: "Contraseña",
      passwordDescription:
        "Cambia la contraseña de esta cuenta de Spartan.",
      passwordDialog: {
    ...
    profile: {
      ...
      stats: {
        ...
        subtitle:
          "Todo lo que aparece a continuación se calcula a partir de tu propio historial. No se recopila ni se envía nada a Spartan.",
        retry: "Volver a intentar",
        privacyNote:
          "Las estadísticas se calculan a partir del historial de chats y entrenamientos que guarda tu instalación de Spartan. No se recopila nada y no se envía nada a Spartan ni a terceros.",
        emptyChats:
    ...
    apiKeys: {
      ...
      secureHttpsHint:
        "El puerto 0.0.0.0 sigue siendo accesible globalmente. Para máxima seguridad, inicia Spartan con --secure para exponer solo este enlace HTTPS.",
    ...
    about: {
      ...
      shutDownStudio: "Apagar Spartan",
      shutDownStudioDescription:
        "Detiene el servidor de Spartan y finaliza tu sesión.",
      shutDown: "Apagar",
      update: {
  ...
  studio: {
    ...
    trainingStart: {
      ...
      terminalStart: "> el entrenamiento de Spartan comienza...",
  ...
  chat: {
    providersDialog: {
      ...
      selectModelHint: "Selecciona sugerencias de abajo o introduce los ID exactos de los modelos.",
      search: "Buscar",
      ...
      chatgptAuthorize: "Autoriza en el navegador del sistema. Los tokens nunca se guardan en el navegador.",
      chatgptReconnect: "La autorización guardada ya no es válida. Vuelve a conectarte para continuar.",
      chatgptConnected: "Conectado de forma segura en esta instalación de Studio.",
      ...
      invalidOrExpiredToken: "La sesión de Studio caducó. Reinicia la conexión e inténtalo de nuevo.",
      ...
      deviceCodeHelp: "Es posible que debas habilitar el inicio de sesión mediante dispositivo en la seguridad de ChatGPT o en la configuración del espacio de trabajo.",
      copyCode: "Copiar código",
      expiresAt: "Caduca a las {time}.",
      callbackHelp: "Si el navegador no puede volver automáticamente, pega la URL completa de devolución de llamada de localhost.",
      complete: "Completar",
      ...
      additionalModelIds: "ID de modelos adicionales (uno por línea o separados por comas)",
      enterModelIds: "O introduce manualmente los ID de modelos (uno por línea o separados por comas)",
      saveConnection: "Guardar conexión",
      addConnection: "Añadir conexión",
      cancel: "Cancelar",
      enableConnections: "Activar conexiones",
      connectionsDisabledHelp: "Cuando está desactivado, se desactivan todas las conexiones.",
      connectionsSummary: "{connections} conexiones · {models} modelos",
      noConnectionsYet: "Aún no hay conexiones",
      noConnectionsHelp: "Añade una conexión para usar modelos alojados desde el chat.",
      ...
      authorizeChatgptSubscription: "Autoriza esta conexión de suscripción de ChatGPT.",
    },
    systemPromptEditor: {
      title: "Editar prompt del sistema",
      description: "Este prompt forma parte de la configuración actual y se guarda con el preajuste.",
      editor: "Editor del prompt",
      variables: "Variables",
      editorHelp: "Úsalo para ediciones largas. Guardar solo actualiza la configuración activa. Inserta variables con {{ env }}.",
      variablesTitle: "Variables del prompt",
      variablesHelp: "Define valores como JSON abajo y usa cada clave en el prompt, por ejemplo {{ env }}.",
      ...
      undefinedVariableHelp: "Los nombres que no definas se mantienen sin cambios, por lo que {{ typo }} seguirá visible en el prompt.",
    ...
    menu: {
      ...
      openFolderDescription: "Abrir la carpeta que usan las herramientas de este chat para leer y escribir",
      openFolderUnavailable: "Para abrir la carpeta necesitas la aplicación de escritorio. En el navegador, guarda el archivo desde la tarjeta que lo creó.",
      multipleFolders: "Este chat escribió en más de una carpeta.",
      multipleFoldersDescription: "Sus paneles se ejecutaron antes de unirse a este proyecto; abre la carpeta desde una tarjeta de herramienta.",
      ...
      noProjectsYet: "Aún no hay proyectos",
      saveToProjectSourcesFailed: "No se pudo guardar en las fuentes del proyecto.",
      archive: "Archivar",
      delete: "Eliminar",
    },
    composer: {
      ...
      permissions: {
        ...
        ask: {
          ...
          description: "Preguntar siempre antes de modificar archivos o usar internet",
        },
        auto: {
          label: "Aprobar por mí",
          description: "Ejecutar herramientas, pero pedir confirmación en acciones críticas o de alto riesgo",
        },
        off: {
          label: "Ejecutar automáticamente",
          description: "Ejecutar herramientas sin confirmaciones dentro del entorno aislado",
        },
        full: {
          label: "Acceso total",
          description: "Sin restricciones: sin confirmaciones y entorno aislado desactivado",
        },
      },
      disclaimer: "Los LLM pueden cometer errores. Verifica la información importante.",
    },
    welcome: {
