export const resources = {
  ...
  llamaBackend: {
    ...
    envLocked:
      "Set to {backend} by the SPARTAN_LLAMA_CPP_BACKEND environment variable, which overrides this setting.",
    customPath: {
    ...
    unsupported: {
      ...
      localLink:
        "llama.cpp is a local directory you linked yourself, so Spartan will not replace it.",
      sourceBuild:
