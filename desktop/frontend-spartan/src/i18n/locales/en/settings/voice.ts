export const voice = {
  ...
  "dictation": {
    ...
    "micNotFound": "No microphone was found for dictation.",
    "micInUse": "The microphone is already in use or unavailable.",
    "micGeneralError": "Dictation could not access the microphone.",
    "speechBlocked": "Speech recognition was blocked by the browser. Check microphone permissions.",
    "speechServiceBlocked": "Speech recognition is blocked by the browser speech service.",
    "speechNetwork": "Speech recognition could not reach the browser speech service.",
    "speechLangUnsupported": "Speech recognition does not support the current language.",
