export const general = {
  ...
  passwordDialog: {
    ...
    setDescription:
      "Choose the password remote browsers sign in with as Spartan (at least {minLength} characters). The Spartan Desktop App keeps signing in automatically.",
  ...
  helperLlm: {
    ...
    disabledByEnv:
      "Disabled by SPARTAN_HELPER_MODEL_DISABLE in the backend environment.",
  ...
  permissions: {
    ...
    bypassDescription:
      "How Spartan approves chat tool calls (terminal, python, web, MCP) before they run. Full access disables approvals and the code sandbox.",
  },
  notifications: {
  ...
  startup: {
    ...
    launchAtLoginDescription:
      "Start Spartan in the background when you log in. It stays in the menu bar or system tray until you open it.",
    closeToTray: "Close to system tray",
    closeToTrayDescription:
      "Keep Spartan and its server running in the background when you close the main window.",
  ...
  resetPreferences: {
    ...
    confirmDescription:
      "Clears local-only preferences and reloads Spartan. Chats, API access, and DB-backed settings are kept.",
