...
import { useIsMobile, cn } from "ia-sparta-core"
  ...
  return (
    ...
    >
      ...
      <div
        ...
        data-side={side}
        className={cn(
          "absolute inset-y-0 z-10 hidden transition-[left,right,width] duration-200 ease-linear md:flex",
...
function SidebarGroupLabel({
  ...
  return useRender({
    ...
    props: mergeProps<"div">(
      {
        className: cn(
          "flex h-6 shrink-0 items-center rounded-md px-2",
