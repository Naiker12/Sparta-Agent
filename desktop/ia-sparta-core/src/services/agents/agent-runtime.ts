/**
 * SINGLE SOURCE SYNC: Keep synchronized with `ia-sparta-agents/src/services/agent-runtime.ts`.
 */
import type { ToolCall, TaskStep, SubagentRun, SubagentStep } from '../../types'
