...
test('VRAM transitions from pending settings to a mounted slider without hook errors', async () => {
...
test('terminal shows the full command during approval, live output, and failure details', async () => {
