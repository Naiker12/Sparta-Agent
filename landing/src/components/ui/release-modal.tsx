...
export function ReleaseModal() {
  ...
  useEffect(() => {
    ...
    const hasSeen = localStorage.getItem('sparta_release_v0.1.9_seen');
    if (!hasSeen) {
  ...
  const handleClose = () => {
    localStorage.setItem('sparta_release_v0.1.9_seen', 'true');
    setIsOpen(false);
  };
    ...
    <>
      ...
      {!isOpen && (
        ...
        >
          ...
          <span className="font-mono text-zinc-300">v0.1.9 disponible</span>
