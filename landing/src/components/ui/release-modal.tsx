...
export function ReleaseModal() {
  ...
  useEffect(() => {
    ...
    const hasSeen = localStorage.getItem('sparta_release_v0.2.17_seen');
    if (!hasSeen) {
  ...
  const handleClose = () => {
    localStorage.setItem('sparta_release_v0.2.17_seen', 'true');
    setIsOpen(false);
  };
    ...
    <>
      ...
      {!isOpen && (
        ...
        >
          ...
          />
          <span className="font-mono text-[11px] text-[#e6e6e6]">v0.2.17 disponible</span>
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 overflow-y-auto bg-black/80 backdrop-blur-xl">
            ...
            >
              ...
              <div className="relative z-10 flex flex-col sm:flex-row items-center gap-2.5 pt-1">
                <a
                  href="https://github.com/Naiker12/Sparta-Agent/releases/latest/download/Sparta-Agent-Windows-0.2.17-Setup.exe"
                  target="_blank"
                ...
                >
                  ...
                  <span>Descargar Sparta v0.2.17 (.exe)</span>
                </a>
