...
export function ReleaseModal() {
  ...
  useEffect(() => {
    ...
    const hasSeen = localStorage.getItem('sparta_release_v0.2.5_seen');
    if (!hasSeen) {
  ...
  const handleClose = () => {
    localStorage.setItem('sparta_release_v0.2.5_seen', 'true');
    setIsOpen(false);
  };
    ...
    <>
      ...
      {!isOpen && (
        ...
        >
          ...
          <span className="font-mono text-zinc-300">v0.2.5 disponible</span>
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 overflow-y-auto bg-black/75 backdrop-blur-md">
            ...
            >
              ...
              <div className="relative z-10 flex flex-col sm:flex-row items-center gap-3 pt-2">
                <a
                  href="https://github.com/Naiker12/Sparta-Agent/releases/latest/download/Sparta-Agent-Windows-0.2.5-Setup.exe"
                  target="_blank"
