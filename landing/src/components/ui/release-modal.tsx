...
export function ReleaseModal() {
  ...
  useEffect(() => {
    ...
    const hasSeen = localStorage.getItem('sparta_release_v0.2.15_seen');
    if (!hasSeen) {
  ...
  const handleClose = () => {
    localStorage.setItem('sparta_release_v0.2.15_seen', 'true');
    setIsOpen(false);
  };
    ...
    <>
      ...
      {!isOpen && (
        ...
        >
          ...
          />
          <span className="font-mono text-[11px] text-[#e6e6e6]">v0.2.15 disponible</span>
            ...
            >
              ...
              <div className="relative z-10 flex flex-col sm:flex-row items-center gap-2.5 pt-1">
                ...
                >
                  ...
                  <span>Descargar Sparta v0.2.15 (.exe)</span>
                </a>
