...
export function CTA() {
  return (
    <section className="py-16 relative bg-[#09090b] text-white border-t border-white/10 font-sans">
      {/* Glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[220px] bg-[#18181b]/15 blur-[120px] pointer-events-none" />
      ...
      <div className="mx-auto max-w-7xl border-x border-white/10 px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#18181b]/10 border border-[#18181b]/30 text-xs font-mono text-[#52525b] font-bold">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
            ...
            >
              <button className="px-6 py-2.5 rounded-xl bg-[#18181b] hover:bg-[#27272a] text-white font-mono font-bold text-xs shadow-lg shadow-[#18181b]/40 transition-all cursor-pointer flex items-center gap-2 border border-[#18181b]">
