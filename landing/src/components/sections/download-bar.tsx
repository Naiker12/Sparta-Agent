...
export function DownloadBar() {
  ...
  const releases = [
    {
      os: 'Windows (x64)',
      filename: 'Sparta-Agent-Windows-0.1.8-Setup.exe',
      size: '~120 MB',
      icon: Monitor,
      recommended: true,
      badge: 'Instalador NSIS .exe',
      command: 'powershell -c "Invoke-WebRequest -Uri https://github.com/Naiker12/Sparta-Agent/releases/download/v0.1.8/Sparta-Agent-Windows-0.1.8-Setup.exe -OutFile Sparta-Setup.exe"',
      url: 'https://github.com/Naiker12/Sparta-Agent/releases/download/v0.1.8/Sparta-Agent-Windows-0.1.8-Setup.exe',
      fallbackUrl: 'https://github.com/Naiker12/Sparta-Agent/releases/tag/v0.1.8',
    },
    {
      os: 'macOS (Apple Silicon & Intel)',
      filename: 'Sparta-Agent-Mac-0.1.8-Installer.dmg',
      size: '~130 MB',
      icon: Apple,
      recommended: false,
      badge: 'Universal .dmg',
      command: 'curl -L https://github.com/Naiker12/Sparta-Agent/releases/download/v0.1.8/Sparta-Agent-Mac-0.1.8-Installer.dmg -o Sparta-Installer.dmg',
      url: 'https://github.com/Naiker12/Sparta-Agent/releases/download/v0.1.8/Sparta-Agent-Mac-0.1.8-Installer.dmg',
      fallbackUrl: 'https://github.com/Naiker12/Sparta-Agent/releases/tag/v0.1.8',
    },
    {
      os: 'Linux (AppImage)',
      filename: 'Sparta-Agent-Linux-0.1.8.AppImage',
      size: '~115 MB',
      icon: Terminal,
      recommended: false,
      badge: 'Binario AppImage',
      command: 'wget https://github.com/Naiker12/Sparta-Agent/releases/download/v0.1.8/Sparta-Agent-Linux-0.1.8.AppImage && chmod +x Sparta-Agent-Linux-0.1.8.AppImage',
      url: 'https://github.com/Naiker12/Sparta-Agent/releases/download/v0.1.8/Sparta-Agent-Linux-0.1.8.AppImage',
      fallbackUrl: 'https://github.com/Naiker12/Sparta-Agent/releases/tag/v0.1.8',
    },
  ];
