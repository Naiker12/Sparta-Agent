...
export function DownloadBar() {
  ...
  const releases = [
    {
      os: 'Windows (x64)',
      filename: 'Sparta-Agent-Windows-0.3.0-Setup.exe',
      size: '~120 MB',
      icon: Monitor,
      recommended: true,
      badge: 'Instalador NSIS .exe',
      command: 'powershell -c "Invoke-WebRequest -Uri https://github.com/Naiker12/Sparta-Agent/releases/latest/download/Sparta-Agent-Windows-0.3.0-Setup.exe -OutFile Sparta-Setup.exe"',
      url: 'https://github.com/Naiker12/Sparta-Agent/releases/latest/download/Sparta-Agent-Windows-0.3.0-Setup.exe',
      fallbackUrl: 'https://github.com/Naiker12/Sparta-Agent/releases/latest',
    },
    {
      os: 'macOS (Apple Silicon & Intel)',
      filename: 'Sparta-Agent-Mac-0.3.0-Installer.dmg',
      size: '~130 MB',
      icon: Apple,
      recommended: false,
      badge: 'Universal .dmg',
      command: 'curl -L https://github.com/Naiker12/Sparta-Agent/releases/latest/download/Sparta-Agent-Mac-0.3.0-Installer.dmg -o Sparta-Installer.dmg',
      url: 'https://github.com/Naiker12/Sparta-Agent/releases/latest/download/Sparta-Agent-Mac-0.3.0-Installer.dmg',
      fallbackUrl: 'https://github.com/Naiker12/Sparta-Agent/releases/latest',
    },
    {
      os: 'Linux (AppImage)',
      filename: 'Sparta-Agent-Linux-0.3.0.AppImage',
      size: '~115 MB',
      icon: Terminal,
      recommended: false,
      badge: 'Binario AppImage',
      command: 'wget https://github.com/Naiker12/Sparta-Agent/releases/latest/download/Sparta-Agent-Linux-0.3.0.AppImage && chmod +x Sparta-Agent-Linux-0.3.0.AppImage',
      url: 'https://github.com/Naiker12/Sparta-Agent/releases/latest/download/Sparta-Agent-Linux-0.3.0.AppImage',
      fallbackUrl: 'https://github.com/Naiker12/Sparta-Agent/releases/latest',
    },
  ];
    ...
    <section id="descargas" className="py-12 relative overflow-hidden max-w-full bg-slate-50/85 dark:bg-[#09090b]/85 backdrop-blur-md text-slate-900 dark:text-white border-y border-slate-200 dark:border-white/10 font-sans transition-colors duration-300">
      ...
      <div className="mx-auto max-w-7xl border-x border-slate-200 dark:border-white/10 px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mt-6 text-center">
          <a
            href="https://github.com/Naiker12/Sparta-Agent/releases/tag/v0.3.0"
            target="_blank"
          ...
          >
            <span>Ver Release Oficial y notas de la versión en GitHub Releases (v0.3.0)</span>
            <ArrowRight className="w-3.5 h-3.5" />
          </a>
        </div>
