...
export function DownloadBar() {
  ...
  const releases = [
    {
      os: 'Windows (x64)',
      filename: 'Sparta-Agent-Windows-0.1.4-Setup.exe',
      size: '368.9 MB',
      icon: Monitor,
      recommended: true,
      badge: 'Instalador NSIS .exe',
      url: 'https://github.com/Naiker12/Sparta-Agent/releases/download/v0.1.4/Sparta-Agent-Windows-0.1.4-Setup.exe',
      fallbackUrl: 'https://github.com/Naiker12/Sparta-Agent/releases/tag/v0.1.4',
    },
    {
      os: 'macOS (Apple Silicon & Intel)',
      filename: 'Sparta-Agent-Mac-0.1.4-Installer.dmg',
      size: '88.6 MB',
      icon: Apple,
      recommended: false,
      badge: 'Universal .dmg',
      url: 'https://github.com/Naiker12/Sparta-Agent/releases/download/v0.1.4/Sparta-Agent-Mac-0.1.4-Installer.dmg',
      fallbackUrl: 'https://github.com/Naiker12/Sparta-Agent/releases/tag/v0.1.4',
    },
    {
      os: 'Linux (AppImage & deb)',
      filename: 'Sparta-Agent-Linux-0.1.4.AppImage',
      size: '91.4 MB',
      icon: Terminal,
      recommended: false,
      badge: 'Binario AppImage',
      url: 'https://github.com/Naiker12/Sparta-Agent/releases/download/v0.1.4/Sparta-Agent-Linux-0.1.4.AppImage',
      fallbackUrl: 'https://github.com/Naiker12/Sparta-Agent/releases/tag/v0.1.4',
    },
  ];
